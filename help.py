...
class Help(commands.Cog):
    ...
    @commands.command(
        name="help", help="Displays help message", usage="kadle.help", hidden=True
    )
    async def help(self, ctx, payload=None):
        ...
        if payload is None:
            ...
            e.description = (
                "These are all the available commands for Kadle Bot,"
                " separated by category. All commands are case sensitive"
            )

            e.set_footer(
                text="Type kadle.help [category] for more info about the category"
            ...
            e.add_field(name="Category: MessageBot", value=messagebot, inline=False)
        ...
        ##            e.add_field(name='Category: Others', value=otherstuff, inline=False)
        ...
        elif payload.upper() == "MESSAGEBOT":
            e.title = "List of commands for Category: MessageBot"
            e.description = "These commands are used to interact with Kadle Bot's messaging features"

            e.set_footer(
                text="Type kadle.help [command] for more info about a command."
            )
            ...
            e.description = (
                "These commands are used to play audio in your voice channel"
            )
            e.set_footer(
                text="Type kadle.help [command] for more info about a command."
            )
            ...
            e.description = (
                "These commands are used to play Kadlemon."
        ...
        ##            e.add_field(name='Category: Others', value=otherstuff, inline=False)
            ...
            e.set_author(name="Category: MessageBot")
            ...
            e.add_field(
                name="Example", value="```kadle.date @Kadle Bot#5024```", inline=False
            )

        elif payload.upper() == "DATEME":
            e.set_author(name="Category: MessageBot")
            e.title = "Command: dateme"
            e.description = "Kadle decides if you're a good match for a date"
            e.add_field(name="Usage", value="```kadle.dateme```", inline=False)
            e.add_field(name="Example", value="```kadle.dateme```", inline=False)

        elif payload.upper() == "HOWCOMPATIBLE":
            e.set_author(name="Category: MessageBot")
            e.title = "Command: howcompatible"
            e.description = "Tells you how compatible you are with Kadle"
            e.add_field(name="Usage", value="```kadle.howcompatible```", inline=False)
            e.add_field(name="Example", value="```kadle.howcompatible```", inline=False)
            ...
            e.add_field(
                name="Examples",
                value="```kadle.add never gonna give you up rick astley```\n```kadle.add all star smash mouth```",
                inline=False,
            )
            ...
            e.description = (
                "Plays a song. Note that Kadle Bot should have joined a voice channel first."
                " Note: For best results with spotify search, use the format [artist] - [track name]"
            )
            e.add_field(
                name="Usage", value="```kadle.play [song name]```", inline=False
            )
            e.add_field(
                name="Examples",
                value="```kadle.play never gonna give you up rick astley```\n```kadle.play all star smash mouth```",
                inline=False,
            )
            ...
            e.add_field(
                name="Usage", value="```kadle.remove [track number]```", inline=False
            )
            ...
            e.description = (
                "Adjusts the volume of the audio player. Volume is between 0-100"
            )
            ...
            e.add_field(
                name="Usage", value="```kadle.setsearch [website]```", inline=False
            )
            e.add_field(
                name="Examples",
                value="```kadle.setsearch spotify```\n```kadle.setsearch youtube```",
                inline=False,
            )
            ...
            e.add_field(
                name="Usage",
                value="```kadle.spawn [text-channel-name]```",
                inline=False,
            )
