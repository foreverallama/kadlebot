...
* Changes to the file system on Heroku are temporary and last only till the dyno is shut down or restarted. Hence, `spawnbot.py` uses MongoDB to store data. If you don't know how to do this, [here's a good tutorial](https://www.youtube.com/watch?v=rE_bJl2GAY8 "MongoDB Python Tutorial") to get you started.
...
* **kadle.howcompatible**
Replies with the compatibility between two mentioned users
